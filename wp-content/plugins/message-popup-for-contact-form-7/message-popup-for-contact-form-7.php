...
function MPFCF7_admin_enqueue_scripts() {
    wp_enqueue_script( 'jquery-color-js', MPFCF7_PLUGIN_DIR. '/public/js/coloris.min.js', array('jquery'), '1.1');
    wp_enqueue_script( 'jquery-colors-js', MPFCF7_PLUGIN_DIR. '/admin/js/design.js', array('jquery'), '1.1');
    wp_enqueue_style( 'jquery-popup-color', MPFCF7_PLUGIN_DIR. '/public/css/coloris.min.css', '', '3.0' );
}
add_action('admin_enqueue_scripts', 'MPFCF7_admin_enqueue_scripts');


function MPFCF7_load_script_style(){
    wp_enqueue_script( 'jquery-popup', MPFCF7_PLUGIN_DIR . '/public/js/sweetalert.min.js', array('jquery'), '2.0');
    // wp_enqueue_script( 'jquery-popups', MPFCF7_PLUGIN_DIR. '/public/js/mpdcf7_index.js', array('jquery'), '1.0');
    wp_enqueue_script( 'jquery-popupss', MPFCF7_PLUGIN_DIR. '/public/js/design.js', array('jquery'), '1.0');
    wp_enqueue_style( 'jquery-popup-style', MPFCF7_PLUGIN_DIR. '/public/css/sweetalert.css', '', '3.0' );
